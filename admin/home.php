...
<section class="section dashboard">
    <div class="row">
      ...
      <div class="col-12">
            <h2 class="subheading" style="font-size: 18px; font-weight: 400; color: #555; text-align: center; margin-bottom: 20px;">
              Manage your services, connect with clients, and grow your business.
            </h2>
          </div>
        <div class="row">
            ...
            <div class="card info-card">
              <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="ps-3">
                    <?php 
                    $services = $conn->query("SELECT * FROM `service_list` where `status` = 1")->num_rows; // cnt the number of active services
                    ?>
